...
## 2. Usuario
Clientes que necesitan alquilar trajes para eventos formales o sociales, y dueños de tiendas que requieren un sistema para gestionar inventario, reservas.

## 3. Contexto
El problema ocurre en ciudades como Santa Cruz de la Sierra, especialmente en temporadas de alta demanda (graduaciones, matrimonios, festividades), cuando las personas buscan un traje para eventos sociales entre semana o fines de semana. Los administradores manejan reservas de forma manual (cuadernos o anotaciones), y la dificultad se presenta entre la búsqueda inicial del traje y la confirmación efectiva de la reserva.
